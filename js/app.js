// ===== THEME =====
// TRANSLATIONS, currentLang, t(), applyI18n(), setLang() — в i18n.js
// DEFAULT_PROXY, PROXY_BASE, vodState, urlInput, goBtn, result, clearBtn, pasteBtn — в utils.js
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (currentService === 'youtube') {
    checkCookiesStatus().then(hasCookies => {
      ...
      if (btn) btn.style.display = hasCookies ? 'none' : 'flex';
    });
  }
});
