...
const TRANSLATIONS = {
  ru: {
    ...
    topbar_text:'happybotloader · twitch + soundcloud',
    ...
    clip_label:'клип', track_label:'трек', playlist_label:'плейлист',
  ...
  en: {
    ...
    clip_label:'clip', track_label:'track', playlist_label:'playlist',
